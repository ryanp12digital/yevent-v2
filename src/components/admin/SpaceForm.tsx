...
export default function SpaceForm({ initialData, action, readOnly = false }: SpaceFormProps) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        disabled={readOnly}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border ${readOnly ? 'bg-gray-100' : ''}`}
                    />
                </div>
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        rows={4}
                        disabled={readOnly}
                        placeholder={readOnly ? "" : "Descreva o espaço ou clique em 'Gerar com IA' para criar automaticamente"}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border ${readOnly ? 'bg-gray-100' : ''}`}
                    />
                    {aiError && (
                ...
                <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                            ...
                            disabled={readOnly}
                            placeholder="Ex: 35"
                            className={`block w-full rounded-l-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border ${readOnly ? 'bg-gray-100' : ''}`}
                        />
                ...
                <div>
                    ...
                    <input
                        ...
                        step="0.01"
                        name="price"
                        defaultValue={initialData?.price as any}
                        disabled={readOnly}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border ${readOnly ? 'bg-gray-100' : ''}`}
                    />
                </div>
